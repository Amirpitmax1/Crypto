...
# ذخیره ادمین‌ها در حافظه
ADMINS = {"admin1"}  # ادمین اولیه

ADMIN_PASSWORD = "123456"  # پسورد ورود پنل مدیریت

# Basic Auth برای پنل مدیریت
def check_auth(username, password):
    return username == "admin" and password == ADMIN_PASSWORD

def authenticate():
    return Response(
        'لطفا برای دسترسی وارد شوید.', 401,
...
<head>
  <meta charset="UTF-8">
  <title>تحلیل تکنیکال ارز دیجیتال</title>
</head>
